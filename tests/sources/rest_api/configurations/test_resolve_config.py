...
def test_process_parent_data_item() -> None:
    ...
    bound_path, expanded_params, parent_record = process_parent_data_item(
...
def test_one_resource_cannot_bind_two_parents(
    ...
    error_part_1 = re.escape(f"Multiple parent resources for user_details: [{resolved_param1}")
    error_part_2 = re.escape(resolved_param2)
